...
***1.安装合成控制法所需的语法命令
ssc install synth  // 如果得到如下反馈：ssc install: "synth" not found at SSC, type search synth。对此需要点击 search synth 的链接进入
*点击 st0500的链接
*点击 (click here to install)
search synth_runner
*点击 st0500 from http://www.stata-journal.com/software/sj17-4
*进入后点击 (click here to install)
*注意：synth命令并不适配ARM架构的MAC电脑，在这种情况下可以安装陈强等开发的synth2命令
ssc install synth2  //该命令只能在Stata16.0版本及以上运行

***2.设置面板格式
xtset Iccd Iyea
*All Iccd 20,52,70,100,101,130,135,145,160,364,365,373,385,475,481,484,540,615,620,625,630,645,651,652,670,690,692,694,696,698,701,704,705,775,816,820,835,850,900) mspeperiod(1960(1)1974) resultsperiod(1960(1)2018) fig 
*说明：委内瑞拉无Aegr1数据，为保持一致所有国家均使用Aegr3数据作为替代

***3.合成控制：委内瑞拉-1975年实施《石油国有化法》，建立起国家产权制度
*3.1. synth命令
synth Aegr3 Bopd1 Bgpd1 Crty1 Cwar1 Cncp1 Cppl1 Crlg2 Ceth1 Crus2, trunit(101) trperiod(1975) xperiod(1960(1)1974) counit(20,52,70,100,130,145,160,385,475,481,484,615,620,630,645,651,652,670,690,692,694,696,698,775,820,850,900) mspeperiod(1960(1)1974) resultsperiod(1960(1)2018) nested allopt fig keep(101)
*打开101.dta文件
generate effect=_Y_treated - _Y_synthetic
line effect _time, xline(1975, lp(dash)) yline(0, lp(dash)) xtitle(年份) ytitle(真实的委内瑞拉与合成的委内瑞拉经济增长的差值)
*3.2. synth2命令
synth2 Aegr3 Bopd1 Bgpd1 Crty1 Cwar1 Cncp1 Cppl1 Crlg2 Ceth1 Crus2, trunit(101) trperiod(1975) preperiod(1960(1)1974) postperiod(1975(1)2018) xperiod(1960(1)1974) mspeperiod(1960(1)1974) ctrlunit(20,52,70,100,130,145,160,385,475,481,484,615,620,630,645,651,652,670,690,692,694,696,698,775,820,850,900) nested allopt fig
synth2 Aegr3 Bopd1 Bgpd1 Crty1 Cwar1 Cncp1 Cppl1 Crlg2 Ceth1 Crus2, trunit(101) trperiod(1975) preperiod(1960(1)1974) postperiod(1975(1)2018) xperiod(1960(1)1974) mspeperiod(1960(1)1974) ctrlunit(20,52,70,100,130,145,160,385,475,481,484,615,620,630,645,651,652,670,690,692,694,696,698,775,820,850,900) nested allopt placebo(unitcut(101)) loo frame(Venezuela)

***4.合成控制：挪威-1985年进行能源管理体制调整，加快在能源领域建立私人产权
*4.1.  synth命令
synth Aegr3 Bopd1 Bgpd1 Crty1 Cwar1 Cncp1 Cppl1 Crlg2 Ceth1 Crus2, trunit(385) trperiod(1985) xperiod(1960(1)1984) counit(20,52,70,100,101,130,145,160,475,481,484,615,620,630,645,651,652,670,690,692,694,696,698,775,820,850,900) mspeperiod(1960(1)1985) resultsperiod(1960(1)2018) nested allopt fig keep(385)
*打开385.dta文件
generate effect=_Y_treated - _Y_synthetic
line effect _time, xline(1985, lp(dash)) yline(0, lp(dash)) xtitle(年份) ytitle(真实的挪威与合成的挪威经济增长的差值)
*4.2. synth2命令
synth2 Aegr3 Bopd1 Bgpd1 Crty1 Cwar1 Cncp1 Cppl1 Crlg2 Ceth1 Crus2, trunit(385) trperiod(1985) preperiod(1960(1)1984) postperiod(1985(1)2018) xperiod(1960(1)1984) mspeperiod(1960(1)1984) ctrlunit(20,52,70,100,101,130,145,160,475,481,484,615,620,630,645,651,652,670,690,692,694,696,698,775,820,850,900) nested allopt fig
synth2 Aegr3 Bopd1 Bgpd1 Crty1 Cwar1 Cncp1 Cppl1 Crlg2 Ceth1 Crus2, trunit(385) trperiod(1985) preperiod(1960(1)1984) postperiod(1985(1)2018) xperiod(1960(1)1984) mspeperiod(1960(1)1984) ctrlunit(20,52,70,100,101,130,145,160,475,481,484,615,620,630,645,651,652,670,690,692,694,696,698,775,820,850,900) nested allopt placebo(unitcut(101)) loo frame(Norway)
